...
class Form extends Component {
      ...
      getDownloadURL(snapshot.ref).then((url) => {
        axios
          ...
          .then((response) => {
            ...
            axios
              .post("http://localhost:9000/api/image", image)
              .then((response) => {
                console.log("**RESPONSE**", response.data);
                this.setState(
                  {
                    savedimageList: this.state.savedimageList.concat(response.data),
                    images: this.state.images.concat(response.data._id),
                  }, ()=>{
            ...
            this.setState(
              {
                loadingEnhancedImage:
                  this.state.loadingEnhancedImage.concat(false),
              },
  ...
  onSaveandContinue(e) {
    ...
    axios
      .post("http://localhost:9000/api/property", property)
      .then((response) => {
        this.setState({
  ...
  enhanceImage(image, index) {
    ...
    axios
      .post(`http://127.0.0.1:5000/enhanceImage`, {
        url: image.url,
      })
      .then((response) => {
        let updatedImage = {
        ...
        axios
          .put(`http://localhost:9000/api/image/${image._id}`, updatedImage)
          .then((response) => {
  ...
  setLoadingSatus(index, status) {
    ...
    this.setState({ loadingEnhancedImage }, () => {
      console.log("new status", this.state.loadingEnhancedImage);
    });
  }
  onSaveImages =(e)=>{
    e.preventDefault();
    ...
    axios
      .put(`http://localhost:9000/api/property/${this.state.propertyId}`,{
        images : images
      })
      .then((response) => {
    ...
    return (
      <div>
        ...
        <div className="container-lg mt-5 mb-5">
          <div
            className="row formWrapper d-flex justify-content-center ps-3 pe-3"
            style={{ height: "100%" }}
          >
...
<p className="fw-bold">House Details</p>
              ...
              <div className="row justify-content-md-center g-3 mb-3">
                ...
                <div className="col-md-6 mb-3">
                  <label for="landSizeUnit" className="form-label">
                    Unit
                  </label>
                  <select
                    name="landSizeUnit"
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  <label for="inputparking" className="form-label">
                    Car Parking Spaces
                  </label>
                  <input
                    name="parking"
                ...
                <div className="col-md-6 mb-3">
                  <label for="inputEmail6" className="form-label">
                    House Size (sqft)
                  </label>
                  <input
                    name="houseSize"
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                    <label for="disctrict" className="form-label">
                      Address
                    </label>
                    <input
                      name="address"
            ...
            <div className="row">
              ...
              )}
              {
                ...
                this.state.saved && !this.state.imagesSaved? <div>
                  <div className="col-12">
                  <button
                    className="btn btn-primary"
