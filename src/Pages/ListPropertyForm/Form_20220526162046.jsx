...
class Form extends Component {
        ...
        uploadBytes(imageRef, this.state.imageUpload).then((snapshot) => {
            getDownloadURL(snapshot.ref).then((url) => {
                ...
                .then(response => {
                    ...
                    axios.post('http://localhost:5000/api/image', image)
                    .then(response => {
    ...
    onSaveandContinue(e) {
        ...
        axios.post('http://localhost:5000/api/property',property)
        .then(response => {
    ...
    enhanceImage(image, index){
        ...
        axios.post(`http://127.0.0.1:5000/enhanceImage`, {
                ...
                .then(response => {
                    ...
                    axios.put(`http://localhost:5000/api/image/${image._id}`, updatedImage)
                    .then(response => {
